...
# ISTools supports Portuguese (Brazil) and English
LOCALES = pt_BR en
...
PEP8EXCLUDE=pydev,resources.py,conf.py,third_party,ui,__pycache__,tests
...
QGISDIR=C:\Users\irlan\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
...
test: compile transcompile
	...
	@# Run ISTools test suite using unittest
	@-export PYTHONPATH=`pwd`:$(PYTHONPATH); \
		export QGIS_DEBUG=0; \
		export QGIS_LOG_FILE=/dev/null; \
		python -m unittest discover tests -v || true
	@echo "----------------------"
